...
df_femme = df[df['Gender'] == 'Female']

# Calculer la moyenne des salaires par pays
salaires_moyens_par_pays = df_femme.groupby('Race')['Salary'].mean().reset_index()
...
plt.title('Moyenne des salaires des femmes par ethnie')
