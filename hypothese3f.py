...
X = df_femme[['Education Level']]  # Variable explicative : 'Education Level'
...
plt.ylabel('Salary')
plt.title('Régression Linéaire Simple - Salaires des Femmes en fonction du niveau d\'études')
plt.legend()
plt.show()